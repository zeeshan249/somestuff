...
<template>
 ...
 <v-form ref="saveCollectionForm" v-model="isSaveCollectionFormValid" lazy-validation>
    ...
    <v-app-bar dark color="primary" >
      ...
      <v-toolbar-title>Notary Refund Entry</v-toolbar-title>
      <v-spacer></v-spacer>
    ...
    <v-container>
       ...
       <v-col cols="12" class="pl-5 pr-5">
           <v-text-field
                    ...
                    <template #label>Enter Receipt Number</template>
                  </v-text-field>
      </v-col>
    </v-row>
            </v-col>
            <v-col cols="12" md="7">
                  ...
                  @pagination="getAllRefundSessionWise" :footer-props="{ itemsPerPageOptions: [15, 30, 50,100,150], }" hide-default-footer
                  >
        ...
        <v-col cols="12" md="12">
                ...
                >
                  ...
                  <template v-slot:top>
                    <v-toolbar flat>
                      <v-toolbar-title>Receipt Wise Refund Details</v-toolbar-title>
                      <v-spacer></v-spacer>
                  ...
                  <template slot="body.append">
                    <tr class="success--text">
                        ...
                        <th class="title"></th>
                        <th class="title"></th>
                        <th class="title">{{ sumField('notary_public_collection_amount') }}</th>
                    </tr>
                </template>
                </v-data-table>
                </div>
  ...
  export default {
    ...
    // Datatable Start
      ...
      tableHeader: [
        ...
        { text: "NP", value: "notary_public_collection_amount", width: "5%" , sortable: false},
