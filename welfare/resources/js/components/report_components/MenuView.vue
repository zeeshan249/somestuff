        ...
        <v-col class="d-flex flex-column ml-2">
          ...
          <v-card outlined="">
            ...
            <v-container>
                  ...
                  <v-row dense>
                    <v-col cols="12" md="4">
                        <v-btn  class="ml-2" dense rounded color="primary" @click="getAllCollection($event);" :disabled="tableDataLoading" >Details Report</v-btn>
                    </v-col>


                     <v-col cols="12" md="4">
                        <v-btn  class="ml-2" dense rounded color="primary" @click="getAllCollectionHeadWise($event);" :disabled="tableDataLoading" >Head Wise</v-btn>
                    </v-col>


                     <v-col cols="12" md="4">
                        <v-btn  class="ml-2" dense rounded color="primary" @click="getAllCollectionAdvocateWise($event);" :disabled="tableDataLoading" >Advocate Wise</v-btn>
                    </v-col>
                </v-row>
