        ...
        <v-row align="center" justify="center">
          <v-col cols="12" sm="12" md="6">
            <v-card class="mx-auto">
              ...
              <v-card-actions>
                <v-btn text small color="primary">{{$t('label_forgot_password')}}</v-btn>
                <v-divider></v-divider>
                ...
                <div class="text-center">
                  <v-btn
                    ...
                    @click="validateLogin"
                  >{{isFormDataProcessing==true?$t("label_validating") : $t("label_login") }}</v-btn>
                </div>
              </v-card-actions>
            </v-card>
          </v-col>
  ...
  data() {
    return {
      ...
      mobileRules: [
        ...
        v => (v && v.length >= 10) || this.$t("label_mobile_number_10_digits")
      ],
        ...
        this.$http
          ...
          .then(({ data }) => {
            ...
            if (data.login_flag == 1) {
              ...
              ls.set("loggedUserId", data.user_data.lms_user_id);
