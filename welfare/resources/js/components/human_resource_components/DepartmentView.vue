              ...
              <v-form ref="saveDepartmentForm" v-model="isSaveDepartmentFormValid" lazy-validation>
                <v-row dense>
                  <v-col cols="12" xs="12" sm="12" md="12">
                    ...
                    <v-text-field
                      :label="label_advocate_share"
                      :hint="advocateShareHint"
                      class="ml-4"
                      v-model="advocateShare"
                      type="text"
                      clearable
                      @keypress="isNumbers"
                    ></v-text-field>
...
export default {
  ...
  data() {
    return {
      ...
      advocateShareHint: this.$t("label_enter_advocate_share"),
      label_advocate_share: this.$t("label_advocate_share"),

      NTShareLabel: this.$t("label_nt_share"),
      NTShareHint: this.$t("label_enter_nt_share"),

      AWCShareLabel: this.$t("label_awf_share"),
      AWCShareHint: this.$t("label_awf_share"),
      ...
      tableHeader: [
        ...
        { text: this.$t("label_LA_name"), value: "AdvocateShare", width: "5%" , sortable: false},
        { text: this.$t("label_NT_name"), value: "NotaryPublicShare", width: "5%" , sortable: false},
        { text: this.$t("label_WF_name"), value: "AWCShare", width: "5%" , sortable: false},
        {
  ...
  methods: {
    ...
    editDepartment(item) {
      ...
      this.advocateShare = item.AdvocateShare;
      this.NotaryPublicShare = item.NotaryPublicShare;
      this.AWCShare  = item.AWCShare ;
    },
        ...
        if (this.isSaveEditClicked == 1) {
          postData = {
            departmentName: this.departmentName,
             advocateShare: this.advocateShare,
             NotaryPublicShare: this.NotaryPublicShare,
             AWCShare : this.AWCShare,
            isSaveEditClicked: 1,
            centerId: ls.get("loggedUserCenterId"),
            loggedUserId:ls.get("loggedUserId")
          };
