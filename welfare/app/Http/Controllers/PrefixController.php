...
class PrefixController extends Controller
{
    ...
    public function savePrefix(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            $result=PrefixModel::savePrefix($centerId,
    ...
    public function getAllPrefix(Request $request)
    {
        ...
        $getData = DB::table("lms_prefix_setting")->
            select(['lms_prefix_setting_id','lms_prefix_module_name',
            'lms_prefix',
    ...
    public function getPrefixModuleWise(Request $request)
    {
        ...
        $centerId = $request->centerId;
        $getQuery = DB::table("lms_prefix_setting")->
        select(['lms_prefix_setting_id','lms_prefix_pattern',
