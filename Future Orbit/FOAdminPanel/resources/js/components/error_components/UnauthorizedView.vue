<template>
  <div>
    <svg id="404-Dave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 220">
      <defs>
    ...
    >
      <template v-slot:default="{ value }">
        <strong class="text-white" dark>
          Will redirect to login in {{ Math.ceil(value) }} milisecond(s)</strong
        >
      </template>
    </v-progress-linear>
  </div>
...
@import "../../../sass/notFound.scss"; //Here i add extra "./"(current directory)
</style>
