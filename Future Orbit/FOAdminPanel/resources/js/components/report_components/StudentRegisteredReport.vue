                            ...
                            <v-list-item two-line>
                                <v-list-item-content>
                                    <v-list-item-title class="text-h5">
                                        <strong
                                            >Student Registered Report</strong
                                        >
                                    </v-list-item-title>
                                    <v-list-item-subtitle
                                        >Home
                                        <v-icon>mdi-forward</v-icon> Report
                                        <v-icon>mdi-forward</v-icon> Student
                                        Registered Report</v-list-item-subtitle
                                    >
                                </v-list-item-content>
                            </v-list-item>
                        </v-toolbar-title>
...
export default {
    ...
    data() {
        return {
            ...
            // Form Data
            lblSelectSource: "Filter By Information Source",
            selectedExamType: "",
    ...
    methods: {
        ...
        getStatusColor(is_source_acive) {
            ...
            if (is_source_acive == "Inactive") return "danger";  
            else return "error";
        },
        getAllActiveSources() {
        ...
        getAllExamSchedule(e) {
            ...
            this.$http
                .get(`web_generate_registered_student_report?page=${e.page}`, {
                    params: postData,
                    headers: { Authorization: "Bearer " + ls.get("token") },
                })
                .then(({ data }) => {
