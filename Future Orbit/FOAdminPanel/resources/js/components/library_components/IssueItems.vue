                    ...
                    >
                        ...
                        <template v-slot:item.item_image="{ item }">
                            <img
                                width="50"
                                height="auto"
                                :src="buildCoverImages(item.item_image)"
                                :lazy-src="buildCoverImages(item.item_image)"
                            />
                        </template>
                        <template v-slot:top>
                            <v-toolbar flat>
...
<script>
import { IssueItems } from "../../components/library_components/IssueItems";
