								...
								<form action="{{route('enquirySubmit')}}" data-toggle="submit" method="POST">
									...
									<div class="form-group">
										<label>School</label>
                                          ...
                                          <option value="{{$school->lms_school_name}}">{{$school->lms_school_name}}</option>
                                          @endforeach 
                                        </select>
									...
									<div class="form-group">
										<label>Class</label>
                                          ...
                                          <option value="{{$streams->lms_course_name}}">{{$streams->lms_course_name}}</option>
                                          @endforeach 
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <i class="mdi mdi-check-circle-outline" id="studentname_err"></i>
									</div>
                                    <div class="form-group">
