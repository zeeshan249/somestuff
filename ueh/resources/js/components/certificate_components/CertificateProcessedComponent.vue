...
{
          text: this.$t("label.label_certificate_number"),
          align: "center",
          sortable: false,
          value: "certificate_ueh_number"
        },
        {
          text: this.$t("label.label_certified_on"),
          align: "center",
          sortable: false,
      ...
      certificateFieldsForExcelDownload: {
        ...
        "Certificate Number": "certificate_ueh_number",
        "Certified On": "certificate_approved_rejected_on",
      },
 ...
 //Snackbar Message
  ...
  methods: {
    ...
    paginate(e) {
      ...
      axios
        .get(`web_get_all_approved_certificate_franchise_wise_list?page=${e.page}`, {
          params: {
