        ...
        },
{
        ...
        {
          text: this.$t("label.label_certificate_generate_date"),
          align: "center",
          sortable: false,
          value: "certificate_created_at"
        },
      ...
      certificateFieldsForExcelDownload: {
        ...
        "Generated Date": "certificate_created_at",
      },
 ...
 //Snackbar Message
  ...
  methods: {
    ...
    paginate(e) {
      ...
      axios
        .get(`web_get_all_generated_certificate_franchise_wise_list?page=${e.page}`, {
          params: {
