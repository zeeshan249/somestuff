        ...
        <v-card>
          ...
          <v-card-title>
            <span
              ...
              class="headline"
            >{{$t('label.label_approve_executive')}}</span>
            <span
              v-if="labelApproveRejectFranchiseClickedProp=='reject'"
              class="headline"
            >{{$t('label.label_reject_executive')}}</span>
          </v-card-title>
      ...
      if (this.$refs.approveRejectFranchiseForm.validate()) {
        ...
        axios
          .post("web_approve_reject_applied_executive", {
            clickedFranchiseId: this.clickedFranchiseDetailsProp.ec_member_id,
            ...
            clickedFranchiseMobileNumber: this.clickedFranchiseDetailsProp
              .ec_member_mobile,
            clickedFranchiseDOB: this.clickedFranchiseDetailsProp.ec_member_dob,
