...
class StudentController extends Controller
{
    ...
    public  function getActiveStudentListFranchiseWise(Request $request)
    {
        ...
        ->where('ueh_student.student_status', '=', 1)
    ...
    public  function getCertificateRequestGeneratedStudentListFranchiseWise(Request $request)
    {
    ...
    public  function getCertifiedStudentListFranchiseWise(Request $request)
    {
    ...
    public function approveRejectCertificate(Request $request)
    {
     $certificateId=$request->certificateId;
     $certificateStatus=$request->certificateStatus;
        $franchiseId=$request->franchiseId;
        $studentId=$request->studentId;
     $result=StudentModel::approveRejectCertificate($certificateId,
     $certificateStatus,$franchiseId,$studentId);
