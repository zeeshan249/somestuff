...
class Property extends Model
{
   ...
   public function PropertyFloor(){
    ...
    public function PropertyImages(){
        return $this->hasMany('App\Models\PropertyImages','property_id','id')->where('type','Image');
    }

    public function PropertyAgent(){
        return $this->hasMany('App\Models\User','user_id','agent_id')->where('users.role_id',26);
    }
}
