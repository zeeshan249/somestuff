...
--
-- Host: localhost:3306
-- Generation Time: Mar 02, 2023 at 05:23 PM
...
(8, 2, 'One New User Created', 1, 'Active', 1, '2023-03-02 16:40:21', NULL, NULL);
...
(1097, 'App\\Models\\User', 1, '708020', '4ad9e2f4c48477acb69aa1a66504dedcb99db1084a87f765c51bc0d206d88e45', '[\"*\"]', '2023-03-02 06:00:00', '2023-03-02 03:05:52', '2023-03-02 06:00:00'),
(1099, 'App\\Models\\User', 3, '883899', 'f0b51a51ce6021b57418365ce3d159384941a553f0e21507492f2613e973e7ab', '[\"*\"]', '2023-03-02 06:15:06', '2023-03-02 03:31:40', '2023-03-02 06:15:06');
...
(2, 1, '$2y$10$XTIW4OxaslZvMRBymswbk.bMb/gprrFiWdDX547W6HMfhNwogULXK', '186884', 'gyrovic@gmail.com', 1, '2023-03-02 14:16:57', NULL, NULL, 'New', 'Victor', 'Victor', 'Victor Victor', 'victor-victor1677746817', 1, '9146', 0),
...
(4, 3, '$2y$10$hgLh9pkXWWQyf2bNKIYvI.S/WNx2hd5D./jGyLS5dbAzDgWM0YMBW', '751290', 'victor.esg@gmail.com', 1, '2023-03-02 16:40:21', NULL, NULL, 'Active', 'Pat', 'Williams', 'Pat Williams', 'pat-williams1677755421', 1, '', 0);
...
--
ALTER TABLE `broker_association`
  MODIFY `broker_association_id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user_details`
  MODIFY `user_details_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `user_tracking`
  MODIFY `user_tracking_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
