         ...
         <div class="col-lg-8 col-md-12 col-sm-12 col-12">
            <div class="blog-details single-post-item format-standard">
               <div class="post-details">
                  ...
                  <div class="post-featured-img">
                     <img class="img-fluid" src="{{url('/')}}/assets/frontend/img/p-1.jpg" alt="">
                  </div>
            ...
            <div class="blog-details single-post-item format-standard">
               ...
               <div class="posts-author">
                  <span class="img"><img class="img-fluid" src="{{url('/')}}/assets/frontend/img/user-1.jpg" alt=""></span>
                     ...
                     <div class="comment-list">
                        <ul>
                           <li class="single-comment">
                              <article>
                                 <div class="comment-author">
                                    <img src="{{url('/')}}/assets/frontend/img/user-1.jpg" alt="">
                                 </div>
                              ...
                              <ul class="children">
                                 <li class="single-comment">
                                    <article>
                                       <div class="comment-author">
                                          <img src="{{url('/')}}/assets/frontend/img/user-2.jpg" alt="">
                                       </div>
                                       <div class="comment-details">
                                          <div class="comment-meta">
                                             <div class="comment-left-meta">
                                    ...
                                    <ul class="children">
                                       <li class="single-comment">
                                          <article>
                                             <div class="comment-author">
                                                <img src="{{url('/')}}/assets/frontend/img/user-4.jpg" alt="">
                                             </div>
                                             <div class="comment-details">
                                                <div class="comment-meta">
                                                   <div class="comment-left-meta">
                           ...
                           <li class="single-comment">
                              <article>
                                 <div class="comment-author">
                                    <img src="{{url('/')}}/assets/frontend/img/user-5.jpg" alt="">
                                 </div>
                                 <div class="comment-details">
                                    <div class="comment-meta">
                                       <div class="comment-left-meta">
                     ...
                     <div class="comment-form">
                        <form action="#">
                           <div class="row">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12">
                                 <div class="form-group">
                                    <a href="#" class="btn btn-theme-light-2 rounded full-width">Submit Now</a>
                                 </div>
                              </div>
                           </div>
                        </form>
