...
use App\Http\Controllers\NoOPDController;
...
Route::post('getHealthTips1', [AppController::class, 'getHealthTips1']);
...
Route::get('getClinicSlotDates', [AppController::class, 'getClinicSlotDates']);
// dummy function to insert slot date
Route::get('insertSlotDate', [AppController::class, 'insertSlotDate']);

/* madhuri Upload and edit reports*/
Route::post('appointmentDocUpload', [AppController::class, 'appointmentDocUpload']);
Route::get('getAppointmentDoc', [AppController::class, 'getAppointmentDoc']);
Route::post('updateBookingId', [AppController::class, 'updateBookingId']);
Route::post('updateBookingReport', [AppController::class, 'updateBookingReport']);
Route::get('deleteAppointmentDoc', [AppController::class, 'deleteAppointmentDoc']);


// Admitted Patient and Group Chat API
Route::post('updateUserUHID', [AppController::class, 'updateUserUHID']);
Route::get('getRegisteredPatient', [AppController::class, 'getRegisteredPatient']);
Route::get('getPatientListWithoutUhid', [AppController::class, 'getPatientListWithoutUhid']);
Route::post('admitPatientByAdmin', [AppController::class, 'admitPatientByAdmin']);
Route::post('UpdateAdmitPatientDetails', [AppController::class, 'UpdateAdmitPatientDetails']);
Route::post('addChatGroup', [AppController::class, 'addChatGroup']);
Route::get('getChatGroup', [AppController::class, 'getChatGroup']);
Route::post('addDoctorInGroup', [AppController::class, 'addDoctorInGroup']);
Route::post('addFamilyMemberInGroup', [AppController::class, 'addFamilyMemberInGroup']);
Route::get('getAllFamilyMemberList', [AppController::class, 'getAllFamilyMemberList']);
Route::get('getAllRelationList', [AppController::class, 'getAllRelationList']);

Route::get('getDoctorIdWithoutPagination', [AppController::class, 'getWithoutPaginationDoctor']);
Route::get('getPatientIdWithoutPagination', [AppController::class, 'getWithoutPaginationPatient']);
Route::post('changeGroupStatus', [AppController::class, 'changeGroupStatus']);
Route::post('addGroupFamilyMember', [AppController::class, 'addGroupFamilyMember']);
Route::get('getMemberApproveList', [AppController::class, 'getMemberApproveList']);
Route::get('getRelationList', [AppController::class, 'getRelationList']);
Route::get('getAdmittedPatientDetails', [AppController::class, 'getAdmittedPatientDetails']);
Route::get('getListAllGroupByDoctor', [AppController::class, 'getListAllGroupByDoctor']);
Route::get('getListAllGroupByStaff', [AppController::class, 'getListAllGroupByStaff']);
Route::post('LeftFromGroup', [AppController::class, 'LeftFromGroup']);

Route::post('addUhidByStaff', [AppController::class, 'addUhidByStaff']);
Route::get('getPendingPatientList', [AppController::class, 'getPendingPatientList']);
Route::get('getActivePatientList', [AppController::class, 'getActivePatientList']);
Route::get('getDischargedPatientList', [AppController::class, 'getDischargedPatientList']);
Route::post('getDoctorsList', [AppController::class, 'getDoctorsList']);
Route::post('SearchPatientList', [AppController::class, 'SearchPatientList']);
Route::post('submitAdmitPatientDetails', [AppController::class, 'submitAdmitPatientDetails']);
Route::post('addGroupByStaff', [AppController::class, 'addGroupByStaff']);
Route::post('addMemberInGroupByStaff', [AppController::class, 'addMemberInGroupByStaff']);
Route::get('getAllGroupList', [AppController::class, 'getAllGroupList']);
Route::post('disableGroup', [AppController::class, 'disableGroup']);
Route::get('getAdmitPatientNotInGroup', [AppController::class, 'getAdmitPatientNotInGroup']);
Route::post('getAllGroupMembers', [AppController::class, 'getAllGroupMembers']);
Route::post('changeMemberStatus', [AppController::class, 'changeMemberStatus']);
Route::post('editAdmitPatientDetails', [AppController::class, 'editAdmitPatientDetails']);
Route::post('enableGroup', [AppController::class, 'enableGroup']);
Route::post('deleteMemberByAdmin', [AppController::class, 'deleteMemberByAdmin']);

// No OPD/OT dates API
Route::get('getNoOPD', [NoOPDController::class, 'Get']);
Route::post('saveNoOPD', [NoOPDController::class, 'Save']);
Route::post('changeOPDStatus', [NoOPDController::class, 'Status']);
Route::post('deleteNoOPD', [NoOPDController::class, 'delete']);