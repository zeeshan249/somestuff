...
->join('roles','roles.id','dm_in_clinic_booking.in_clinic_booking_made_by_role_id')            ->select('dm_in_clinic_booking.in_clinic_booking_slot_position','dm_doctor.doctor_full_name','dm_clinic.clinic_full_name','dm_in_clinic_booking.disease_name'
...
'roles.name as booking_made_by',
                \DB::raw('(CASE
                     ...
                     WHEN dm_in_clinic_booking.in_clinic_booking_is_active = "4" THEN "Absent"
                        END) AS status'),
                'dm_in_clinic_booking.source',
				'dm_in_clinic_booking.old_new',
                'dm_in_clinic_booking.type',
                'dm_in_clinic_booking.location',
